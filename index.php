...
<hr noshade></center><form action="index.php" method="post"><input type="text" autofocus name="clip" value="" required autocomplete="off" placeholder="Type here... "><input type="submit" value="Send" onClick="this.value='Sending…';"> <a target="amr" href="clear.php" style="text-decoration:none" title="clear chat">x</a></form></strong>
<?php
error_reporting(0);
